...
def get_args_parser():
    ...
    parser.add_argument('--rmot_path', default='refer-kitti', type=str)
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/refer-kitti.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--num_sentences', type=int, default=6)
    parser.add_argument('--random_sentences', action='store_true', default=False)
    parser.add_argument('--ref_score_thresh', type=float, default=0.5)
    parser.add_argument('--refer_loss_coef', default=2, type=float)
    parser.add_argument('--save_rate', default=1, type=int)
    parser.add_argument('--prob_threshold', type=float, default=0.7)
    parser.add_argument('--refer_threshold', type=float, default=0.5)
    parser.add_argument('--visualization', action='store_true', default=False)
    parser.add_argument('--clip_token_lengths', type=int, default=15)
    return parser
...
def main(args):
    ...
    param_dicts = [
        {
            "params": [p for n, p in model_without_ddp.named_parameters() if
                       not match_name_keywords(n, args.lr_backbone_names) and not match_name_keywords(n,
    ...
    if args.pretrained is not None:
        model_without_ddp = load_model(args, model_without_ddp, args.pretrained)
