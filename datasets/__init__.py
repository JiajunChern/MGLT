...
from .refer_kitti import build as build_e2e_refer_kitti
from .refer_bdd import build as build_rmot_bdd


def build_dataset(image_set, args):
    if args.dataset_file == 'e2e_dance':
        return build_e2e_dance(image_set, args)
    elif args.dataset_file == 'e2e_refer_kitti':
        return build_e2e_refer_kitti(image_set, args)
    elif args.dataset_file == 'e2e_refer_bdd':
        return build_rmot_bdd(image_set, args)
